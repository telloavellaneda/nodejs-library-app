...
PrimeFaces.widget.Ultima = PrimeFaces.widget.BaseWidget.extend({
    ...
    _bindEvents: function () {
        ...
        this.profileButton.off('click.profileButton').on('click.profileButton', function (e) {
            ...
            if (expanded)
            {
                $('.menu-acordeon').removeClass('acordeon-chico');
                $('.menu-acordeon').toggleClass('acordeon-grande');
            } else
            {

                $('.menu-acordeon').removeClass('acordeon-grande');
                $('.menu-acordeon').toggleClass('acordeon-chico');
            }
