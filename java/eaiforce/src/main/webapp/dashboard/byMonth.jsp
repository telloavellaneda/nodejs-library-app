...
java.util.LinkedHashMap<String,java.util.LinkedHashMap<String,String>> dataSet = fu.getDashboardSet("dsByMonths");
%>
<table class="widget">
			...
			<tr class="widget-mobile <%= evenOddClass %>">
				<td colspan="5">
					<table>
						<tr>
							<td>Periodo</td>
							<td id="bold"><%= fu.getFilterCatalogueValue("months", row.get("MESES")) %></td>
						</tr>
						<tr>
							<td>Clientes</td>
							<td id="bold"><%= row.get("CLIENTES") %></td>
