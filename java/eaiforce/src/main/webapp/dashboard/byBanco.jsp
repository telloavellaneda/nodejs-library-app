...
java.util.LinkedHashMap<String,java.util.LinkedHashMap<String,String>> dataSet = fu.getDashboardSet("dsByBancos");
%>
<table class="widget">
	...
	if ( dataSet != null ) {
		for (java.util.Iterator<java.util.LinkedHashMap<String,String>> iterator = dataSet.values().iterator(); iterator.hasNext(); ) {
			...
			<tr class="widget-desktop <%= evenOddClass %>">
				<td>
					<%= fu.displayBankLogo(row.get("ID_BANCO"), row.get("BANCO"), "22") %>
					<span><%= row.get("BANCO") %></span>
				</td>
